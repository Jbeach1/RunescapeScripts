...
@ScriptManifest(author = "Josh", name = "Fisher", version = 1.0, description = "power levels fishing based on skill level"
...
public class Fisher extends AbstractScript {
	...
	public void dropItLikeItsHot() {
		if (getInventory().isFull()) {
			getInventory().dropAllExcept("Small fishing net" , "Bronze axe" , "Mithril axe", "Fly fishing rod", "Feather", "Rune axe", "Mithril pickaxe", "Rune pickaxe");
